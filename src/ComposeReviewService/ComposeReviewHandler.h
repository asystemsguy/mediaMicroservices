...
void ComposeReviewHandler::UploadMovieId(
  ...
  auto span = opentracing::Tracer::Global()->StartSpan("UploadMovieId");
...
void ComposeReviewHandler::UploadUserId(int64_t req_id, int64_t user_id, const std::map<std::string, std::string> & carrier) {
  ...
  // Initialize a span
  std::map<std::string, std::string> writer_text_map;
  auto span = opentracing::Tracer::Global()->StartSpan("UploadUserId");
...
void ComposeReviewHandler::UploadUniqueId(
  ...
  // Initialize a span
  std::map<std::string, std::string> writer_text_map;
  auto span = opentracing::Tracer::Global()->StartSpan("UploadUniqueId");
...
void ComposeReviewHandler::UploadText(
  ...
  std::map<std::string, std::string> writer_text_map;
  auto span = opentracing::Tracer::Global()->StartSpan("UploadText");
...
void ComposeReviewHandler::UploadRating(int64_t req_id, int32_t rating, const std::map<std::string, std::string> & carrier) {
